...
public class CodeView extends Component {
	...
	public final static int DOT = 2; // 干扰点
	private final String chars = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789"; // 验证码字符的集合串
	...
	public void setDisturbType(int disturb_type) {
		...
		g2d.setFont(new Font("斜体", Font.ITALIC, height / 5 * 4)); // 设置画笔的字体
